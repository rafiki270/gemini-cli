...
import type { Config, FileSearch } from '@unlikeotherai/gemini-cli-core';
import {
  FileSearchFactory,
  FileDiscoveryService,
  escapePath,
} from '@unlikeotherai/gemini-cli-core';
import type { FileSystemStructure } from '@unlikeotherai/gemini-cli-test-utils';
import {
  createTmpDir,
  cleanupTmpDir,
} from '@unlikeotherai/gemini-cli-test-utils';
