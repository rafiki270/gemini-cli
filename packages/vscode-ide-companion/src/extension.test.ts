...
import {
  IDE_DEFINITIONS,
  detectIdeFromEnv,
} from '@unlikeotherai/gemini-cli-core/src/ide/detect-ide.js';

vi.mock('@unlikeotherai/gemini-cli-core/src/ide/detect-ide.js', async () => {
  const actual = await vi.importActual(
    '@unlikeotherai/gemini-cli-core/src/ide/detect-ide.js',
  );
  return {
    ...actual,
