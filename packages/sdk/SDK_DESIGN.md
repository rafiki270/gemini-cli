...
```ts
import { GeminiCliAgent } from '@unlikeotherai/gemini-cli-sdk';
...
```ts
import { GeminiCliAgent, tool, z } from "@unlikeotherai/gemini-cli-sdk";
...
```ts
import { GeminiCliAgent, hook, z } from '@unlikeotherai/gemini-cli-sdk';
...
```ts
import { hook } from "@unlikeotherai/gemini-cli-sdk";
...
```ts
import { GeminiCliAgent, subagent } from "@unlikeotherai/gemini-cli";
...
```ts
import { GeminiCliAgent, extension } from "@unlikeotherai/gemini-cli-sdk";
...
```ts
import { GeminiCliAgent } from "@unlikeotherai/gemini-cli-sdk";
import { GeminiCliAcpServer } from "@unlikeotherai/gemini-cli-sdk/acp";
